...
Shiny automatically creates an object called "input" for you. When you create a widget, shiny will perform the following assignment implicitly in the background:
