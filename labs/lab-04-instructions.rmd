...
When you have completed your assignment, click the "Run App" button to ensure your dashboard functions. Note that for this assignment you will only create a `.RMD` file, not an `.HTML` file.
...
With prior labs, you would use the `.RMD` file to knit into an `.HTML` format. For this lab, you only need to run the `.RMD` file.
